...
module "base_shared_vpc" {
  source                        = "github.com/terraform-google-modules/terraform-example-foundation//3-networks/modules/base_shared_vpc?ref=v2.0.0"
  count                         = var.enable_hub_and_spoke ? 1 : 0
...
module "restricted_shared_vpc" {
  source                           = "github.com/terraform-google-modules/terraform-example-foundation//3-networks/modules/restricted_shared_vpc?ref=v2.0.0"
  count                            = var.enable_hub_and_spoke ? 1 : 0
